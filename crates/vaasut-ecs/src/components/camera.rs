...
use vaasut_math::{Vec2, Vec3, Color};

/// 2D камера (ортографическая)
/// Рендерит сцену в 2D проекции (как в платформерах, топ-даун играх)
#[derive(Debug, Clone)]
pub struct Camera2D {
...
impl Camera3D {
    ...
    /// Возвращает соотношение сторон (пока фиксированное, будет меняться)
